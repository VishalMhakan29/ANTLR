...
//alwaysAsKeyword:                                ALWAYS space+ AS;
...
incrementByKeyword:                             INCREMENT_BY;
...
indexParameters:                                ( (space? includeKeyword leftBracketSpace (columnName (space? comma space? columnName)*) rightBracketSpace )?
                                                 ...
                                                 (space? usingKeyWord space? index (createIndexStatement)? space? (tableSpace tablespaceName)?)?);
createIndexStatement:                            CREATE ~(TABLESPACE)+;
