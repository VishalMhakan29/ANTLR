...
start:                                  (normalTable | typeTable  | partitionTable) space* semicolon?;
normalTable:                            createKeyWord space* (globalOrLocal? space* (temporaryType|unLogged) space*)? tableKeyWord space* ifNotExists? space* variableName
                                        ...
                                        ( partitionByKeyWord space* edbPartitionDefinition)|
                                        ...
                                        (space* ((noParallel) | (parallel space+ parallelValue?))))*;
...
indexParameters:                        (space* includeKeyWord leftBracketSpace (columnName (space* comma space* columnName)*) rightBracketSpace )?
                                        ...
                                        (space* usingKeyWord space* index space* createIndexStatement (tableSpace tablespaceName)?)?;
...
edbPartitionDefinition:                 rangePartition | listPartition | hashPartition;
//hash partition
hashPartition:                          hash space* leftBracketSpace columnName ( space* comma space* columnName)*   rightBracketSpace
                                        (space* subPartitionBy space* (range|list|hash) space* leftBracketSpace subPartitionColumnName ( space* comma space* subPartitionColumnName) *   rightBracketSpace subPartitionDefinition?
                                        (space* subPartitionTemplate space* leftBracketSpace hashSubPartitionTemplateDescription rightBracketSpace )? )?
                                        (space* subPartitions space* subPartitionNumbers)? (space* storeIn space* leftBracketSpace subPartitionTableSpaceName ( space* comma space* subPartitionTableSpaceName)*   rightBracketSpace)?
                                        (space* partitions space* partitionNumbers)? (space* storeIn space* leftBracketSpace partitionTableSpaceName ( space* comma space* partitionTableSpaceName)*   rightBracketSpace)?
                                        (space* leftBracketSpace hashPartitionDefinition (space* comma space* hashPartitionDefinition)* rightBracketSpace)?;

hashPartitionDefinition:                space* partition (space* partitionName)?
                                         (space* tableSpace space* tablespaceName)?
                                         (space* ((leftBracketSpace subPartitionDefinition (space* comma space* subPartitionDefinition)* rightBracketSpace) | (subPartitionDefinition (space* comma space* subPartitionDefinition)*) ))?;


hashSubPartitionTemplateDescription:     (space* subPartition  (space* subPartitionName)?
                                                                                (space* values space*  leftBracketSpace value ( space* comma space* value)*   rightBracketSpace)?
                                                                                (space* valuesLessThan space*  leftBracketSpace value ( space* comma space* value)*   rightBracketSpace)?
                                                                                (space* tableSpace space* tablespaceName)?)
                                                                                           (space* comma
                                                                                           (space* subPartition  (space* subPartitionName)?
                                                                                                                                   (space* values space*  leftBracketSpace value ( space* comma space* value)*   rightBracketSpace)?
                                                                                                                                   (space* valuesLessThan space*  leftBracketSpace value ( space* comma space* value)*   rightBracketSpace)?
                                                                                                                                   (space* tableSpace space* tablespaceName)?)
                                                                                           )*;
...
//range partition
rangePartition:                         range space* leftBracketSpace columnName ( space* comma space* columnName)*   rightBracketSpace
                                        (space* interval space* (constant | expression) )?
                                        (space* subPartitionBy space* (range|list|hash) space* leftBracketSpace subPartitionColumnName ( space* comma space* subPartitionColumnName) *   rightBracketSpace subPartitionDefinition?
                                        (space* subPartitionTemplate space* leftBracketSpace rangeSubPartitionTemplateDescription rightBracketSpace )? )?
                                        (space* leftBracketSpace rangePartitionDefinition (space* comma space* rangePartitionDefinition)* rightBracketSpace);

rangePartitionDefinition:                space* partition (space* partitionName)?
                                        (space* valuesLessThan space*  leftBracketSpace value ( space* comma space* value)*   rightBracketSpace)
                                        (space* tableSpace space* tablespaceName)?
                                        (space* ((leftBracketSpace subPartitionDefinition (space* comma space* subPartitionDefinition)* rightBracketSpace) | (subPartitionDefinition (space* comma space* subPartitionDefinition)*) ))?;

rangeSubPartitionTemplateDescription:     (space* subPartition  (space* subPartitionName)?
                                                                                 (space* values space*  leftBracketSpace value ( space* comma space* value)*   rightBracketSpace)?
                                                                                 (space* valuesLessThan space*  leftBracketSpace value ( space* comma space* value)*   rightBracketSpace)?
                                                                                 (space* tableSpace space* tablespaceName)?)
                                                                                            (space* comma
...
//list partition:
listPartition:                          list space* leftBracketSpace columnName  rightBracketSpace (automatic)?
                                        (space* subPartitionBy space* (range|list|hash) space* leftBracketSpace subPartitionColumnName ( space* comma space* subPartitionColumnName) *   rightBracketSpace subPartitionDefinition?
                                        (space* subPartitionTemplate space* leftBracketSpace listSubPartitionTemplateDescription rightBracketSpace )? )?
                                        (space*  leftBracketSpace space*  listPartitionDefinition (space* comma space* listPartitionDefinition)*  space * rightBracketSpace );


listPartitionDefinition:                space* partition (space* partitionName)?
                                        (space* values space*  leftBracketSpace value ( space* comma space* value)*   rightBracketSpace)
                                        (space* tableSpace space* tablespaceName)?
                                       (space* ((leftBracketSpace subPartitionDefinition (space* comma space* subPartitionDefinition)* rightBracketSpace) | (subPartitionDefinition (space* comma space* subPartitionDefinition)*) ))?;

listSubPartitionTemplateDescription:     (space* subPartition  (space* subPartitionName)?
                                        (space* values space*  leftBracketSpace value ( space* comma space* value)*   rightBracketSpace)?
                                        (space* valuesLessThan space*  leftBracketSpace value ( space* comma space* value)*   rightBracketSpace)?
                                        (space* tableSpace space* tablespaceName)?)
                                                   (space* comma
...
subPartitionDefinition:                 listSubPartition | rangeSubPartition | hashSubPartition ;
listSubPartition:                       space* subPartition (space* subPartitionName)?
                                        (space* values space*  leftBracketSpace value ( space* comma space* value)*   rightBracketSpace)
                                        (space* tableSpace space* tablespaceName)?;
rangeSubPartition:                       space* partition (space* partitionName)?
                                        (space* valuesLessThan space*  leftBracketSpace value ( space* comma space* value)*   rightBracketSpace)
                                        (space* tableSpace space* tablespaceName)?;
hashSubPartition:                       (space* subPartition  (space* subPartitionName)?
                                                                                (space* tableSpace space* tablespaceName)?) | (subPartitions space* subPartitionNumbers (space* storeIn space* leftBracketSpace subPartitionTableSpaceName ( space* comma space* subPartitionTableSpaceName)*   rightBracketSpace)?);
...
//expression:                             word| DIGIT+ | ~(RT_BRACKET) |(leftBracketSpace .*? rightBracketSpace ) | ~SEMI_COLON ;
indexMethod:                            word;
